<%-- 
    Document   : admitcardmgmt
    Created on : Aug 9, 2019, 10:15:10 PM
    Author     : Ajay Pandey
--%>
...
<html>
    <head>
        ...
        <title>Admit card management..</title>
     ...
     <%@include file="../AdminZone/header2.jsp"%>
        <div class="container-fluid">
            <div class="row" style="min-height: 480px">
                <div class="col-sm-4" style="height: 576px;background:#c1c1c1;color: white;border-radius: 10px;border: 1px solid black; ">
...
Detail</b></h4></a></li>
    ...
    <li role="separator" class="divider"></li>
                     ...
                     <div class="form-group">
                          <div class="col-sm-9 " style="width:100%; margin-top: 100px ">
    ...
    <li role="separator" class="divider"></li>
               ...
               <div class="col-sm-8" style="min-height: 480px;background: #c1c1c1; color: white;border-radius: 10px;border: 1px solid black; ">
                ...
                <div class="col-sm-2"><a href="../UserZone/logout.html"><center><span class="glyphicon glyphicon-log-out" title="LOGOUT" aria-hidden="true" style="font-size:50px;margin-top: 20px"></span></center></a></div>
                   ...
                   <h2 style="color: black"><b><u>Admit card_Management:-</u></b></h2>
        
                   <div style="border:2px solid #337ab7;border-radius: 10px;min-height: 150px;width: 100%" >
                       <form action="../adcard" method="post" enctype="multipart/form-data">
                           <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input name="name" type="text" id="firstName" placeholder="Full Name.." class="form-control" >
                            ...
                            <div class="form-group">
                                <h4 style="color: black"><b>Roll No:-</b></h4>
                    <div class="col-sm-9">
                        <input  name="rollno" type="digit" id="firstName" placeholder="Enter roll no.." class="form-control" >
                    </div>
                            </div><br>
                ...
                <div class="form-group">
                                <h4 style="color: black"><b>Rank:-</b></h4>
                    <div class="col-sm-9">
                        <input  name="rank" type="digit" id="firstName" placeholder="Enter rank here.." class="form-control" >
                    </div>
                </div><br>
                            <div class="form-group">
                   <h4 style="color: black"><b> Upload AdmitCard:-</b></h4>
                    <div class="col-sm-9">
                        <input name="resume"  required="required" type="file" class="form-control"/>
                    </div>
                </div> 
                         <br>   <br>
                ...
                <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-primary  btn-block" style="width: 40%;margin-left: 50px">Generate Admit Card</button>
