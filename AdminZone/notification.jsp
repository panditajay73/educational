<%-- 
    ...
    Created on : Aug 9, 2019, 9:50:12 PM
    Author     : Ajay Pandey
--%>
    ...
    <li role="separator" class="divider"></li>
               ...
               <div class="col-sm-8" style="min-height: 480px;background: #c1c1c1; color: white;border-radius: 10px;border: 1px solid black; ">
                ...
                <div class="col-sm-2"><a href="../UserZone/logout.html"><center><span class="glyphicon glyphicon-log-out" title="LOGOUT" aria-hidden="true" style="font-size:50px;margin-top: 20px"></span></center></a></div>
                   ...
                   <h2 style="color: black"><b><u>Notification_Management:-</u></b></h2>
        
                   <div style="border:2px solid #337ab7;border-radius: 10px;min-height: 150px;width: 100%" >
                       <form action="../codes/addnoticode.jsp" method="post">
                            
                       
                           <div class="form-group">
                               <h2 style="color: black"><b>Notifications:-</b></h2><br>
                    <div class="col-sm-9">
                        <textarea name="msg" type="text" id="firstName" placeholder="Notifications..." class="form-control" ></textarea>
                    </div>
                           </div><br><br><br>
                ...
                <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-primary  btn-block" style="width: 40%;margin-left: 50px">Add Notification</button>
