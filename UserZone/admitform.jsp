<%-- 
    Document   : admitform
    Created on : Aug 9, 2019, 10:04:43 PM
    Author     : Ajay Pandey
--%>
...
<html>
    <head>
        ...
        <title>Download Admit form..</title>
                ...
                <div class="col-sm-2"><a href="logout.html"><center><span class="glyphicon glyphicon-log-out" title="LOGOUT" aria-hidden="true" style="font-size:50px;margin-top: 20px"></span></center></a></div>
                    ...
                    <div class="col-sm-12">
                        <table border="3" style="width:100%">
                             <h2 style="color: black"><b><u>Download Admit Card:-</u></b></h2>
                        ...
                        String command="select * from admitcard ";
                                  ...
                                  <td style=";color:red;text-align: center"><%=rs.getString(3)%></td>
                                   <td style=";color:red;text-align: center"><%=rs.getString(4)%></td>
                                    <td style=";color:red;text-align: center"><%=rs.getString(5)%></td>
                                     ...
                                     <td style="text-align: center" title="download your admit card"><a href="../resumes/<%=rs.getString(6)%>" ><span class="glyphicon glyphicon-download" aria-hidden="true" style="font-size: 30px;color: black" ></span></a></td>
                            </tr>
